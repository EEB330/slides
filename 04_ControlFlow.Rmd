...
- These objects can be numbers (integer and double), strings (characters), or logical (boolen)
...
- Objects can modified, either by replacing the object with a new value, or modifying only a part of the object
...
- This allows us to return to previous versions of code, and to 
]
