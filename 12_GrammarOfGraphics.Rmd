...
- We have two good options for creating panels with several plots:
  - [`cowplot`](https://cran.r-project.org/web/packages/cowplot/vignettes/introduction.html) has the plot_grid() function
  which has good sensible defaults, can take lists of plots, and set plot labels
