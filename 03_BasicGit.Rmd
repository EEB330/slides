...
$ git pull
$ git stash pop (add your local change on top of the pulled version)
```
...
--
.pull-right[
![:scale 60](figures/gitworkflow.avif)
]
...
But what happens now someone does a commit on the `master` branch??
...
* This is where **conflicts** can happen -- and it's a big deal!  
