...
## R arithmetics and math functions   
...
- All objects in a vector are of the same type (numeric, character, logical, ...)
- Single objects are length-one vectors
...
## Vectors and matrices are homogenenous

- All the elements in a vector or matrix must be of the same type
...
In this function, "a" and "b" are **arguments**
