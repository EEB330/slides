...
#### Getting start
GitHub maintains a super nice getting started guide that deals with getting authentication set up: [https://docs.github.com/en/get-started/getting-started-with-git](https://docs.github.com/en/get-started/getting-started-with-git)


##### Other authentication notes
